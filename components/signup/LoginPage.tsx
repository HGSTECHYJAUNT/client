  ...
  return (
    <div className="min-h-screen flex">
      ...
      <motion.div
        ...
        className="w-full lg:w-1/2 bg-white p-8 flex flex-col justify-center"
      >
        <div className="max-w-md mx-auto w-full">
          {/* Content */}
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }}>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Login</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="relative">
                <input
                  ...
                  onKeyPress={(e) => e.key === "Enter" && handleSubmit()}
                  className="w-full px-4 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3C14B8] focus:border-transparent transition-all"
                />
                <button
                  type="button"
      ...
      <motion.div
        ...
        animate={{ x: 0, opacity: 1 }}
        transition={{ duration: 0.6 }}
        className="hidden lg:flex w-1/2 bg-linear-to-br from-[#1a0e3e] via-[#2d1b69] to-[#3C14B8] p-12 flex-col justify-center items-center text-white relative overflow-hidden"
      >
